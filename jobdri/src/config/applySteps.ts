...
export const APPLY_STEPS: ApplyStep[] = [
  { label: "유형 선택",  path: "/apply",          exact: true },
  { label: "공고 생성",  path: "/apply/job/create"              },
  { label: "공고 확인",  path: "/apply/job/confirm"             },
  { label: "문항 선택",  path: "/apply/virtual"                 },
  { label: "자소서 입력", path: "/apply/write"                  },
  { label: "결과 확인",  path: "/apply/result"                  },
];
